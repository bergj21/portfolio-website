        ...
        <div>
          <div className="contact_information">
            ...
            <div>
              ...
              <span className="contact_subtitle">201-321-1443</span>
            </div>
          </div>
          <div className="contact_information">
            ...
            <div>
              ...
              <span className="contact_subtitle">johnberg2021@gmail.com</span>
            </div>
          </div>
          <div className="contact_information">
            ...
            <div>
              ...
              <span className="contact_subtitle">New York, NY</span>
            </div>
          </div>
        </div>
